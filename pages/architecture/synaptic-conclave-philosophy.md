...
> **Documento storico** (22 maggio 2026). Superato e ampliato da [Vitruvyan Neural Architecture](./vitruvyan-neural-architecture) (30 maggio 2026), che eredita la tesi del bus come differenziatore e aggiunge lo strato corticale (Cortex Atlas) come forma operativa del consolidamento mnesico promesso al §3.3. Mantenuto qui come predecessore e archivio della conversazione che ha originato la visione.

**Data**: 22 maggio 2026
**Stato**: Documento storico — predecessore di [Vitruvyan Neural Architecture](./vitruvyan-neural-architecture)
...
> 📝 **Nota retrospettiva (30 maggio 2026)**: questo "livello di consolidamento mnesico" è esattamente ciò che [Vitruvyan Neural Architecture](./vitruvyan-neural-architecture) ha articolato sei giorni dopo come **strato corticale** del sistema neurale, implementato come scaffold dormante con il nome **Cortex Atlas** in vitruvyan-core v1.29.0.
...
Esempi:
- `system.contract.drift_detected` — un nodo del LangGraph sta producendo payload che non rispettano il contratto atteso
...
> 📝 **Nota retrospettiva (30 maggio 2026)**: il "decadimento controllato" è stato formalizzato come M2 (Decay Manager) dello scaffold Cortex Atlas. Le "promozioni automatiche" come M3 (Consolidator). Vedi [Vitruvyan Neural Architecture §4](./vitruvyan-neural-architecture#4-le-quattro-meccaniche-m1-m4--il-gate-m0).
...
- [Vitruvyan Neural Architecture](./vitruvyan-neural-architecture) — successore (30 maggio 2026), articola lo strato corticale (Cortex Atlas)
- [Dual Memory Layer](./dual-memory-layer)
- [vitruvyan-core v1.29.0 release](https://github.com/vitruvyan/vitruvyan-core/releases/tag/v1.29.0) — Cortex Atlas scaffold
